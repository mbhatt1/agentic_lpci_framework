# 🛡️ Logic Prompt Control Injection Security Benchmark Framework 🛡️
...
**LPCI (Logic Prompt Control Injection)** represents a new shift in AI security vulnerabilities. Unlike traditional prompt injections that affect single interactions, LPCI attacks are persistent, cross-session, infrastructure-level exploits that can compromise entire AI systems.
...
- **New approach** to compromising the foundational layers that AI systems rely on
